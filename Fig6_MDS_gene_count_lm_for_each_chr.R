...
pdf(file="MDS_1D_and_gene_count_and_lm_chr1_based_all_chr_win104.pdf",width=10,height=5)
...
floor(mid_pos) -> wid_mid_pos
pdf(file="MDS_1D_and_gene_count_and_lm_chr2_based_all_chr_win104.pdf",width=10,height=5)
layout(matrix(c(1,2,3,3), nrow=2),heights=c(2,2,4))
par(mar=c(4.5,5,1.5,1))
...
floor(mid_pos) -> wid_mid_pos
pdf(file="MDS_1D_and_gene_count_and_lm_chr3_based_all_chr_win104.pdf",width=10,height=5)
layout(matrix(c(1,2,3,3), nrow=2),heights=c(2,2,4))
par(mar=c(4.5,5,1.5,1))
...
floor(mid_pos) -> wid_mid_pos
pdf(file="MDS_1D_and_gene_count_and_lm_chr4_based_all_chr_win104.pdf",width=10,height=5)
layout(matrix(c(1,2,3,3), nrow=2),heights=c(2,2,4))
par(mar=c(4.5,5,1.5,1))
