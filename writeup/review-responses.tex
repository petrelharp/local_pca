...
\reply{
    ...
    the \LaTeX source code is available at \url{https://github.com/petrelharp/local_pca} 
    (run `make local\_pca\_paper.pdf' in the `writeup/' directory) 
    -- the reviewer is welcome to change the formatting and recompile.
}
