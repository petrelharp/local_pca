...
\reply{
    Good point: we now reference this work \revref.
}
...
\reply{
    We greatly prefer named references rather than numbers, but
    the \LaTeX source code is available at \url{https://github.com/petrelharp/local_pca} (run `make local_pca_paper.pdf' in the `writeup/' directory) -- the reviewer is welcome to change the formatting and recompile.
}
