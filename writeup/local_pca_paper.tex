...
As depicted in Figure \ref{fig:diagram}, these are
...
\begin{figure}
    \begin{center}
       \includegraphics{Fig5_MDS_and_gene_count_allchr_update}
    \end{center}
    \caption{
...
How can we expect selection to affect population structure?
...
\begin{figure}
    ...
    \caption{
        ...
        The small group of windows with positive MDS values lie around the inversion at 8p23.
...
\begin{figure}
    ...
    \caption{
        ...
        \plr{better caption: which windows?}
