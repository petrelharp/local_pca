...
The kinship matrix goes back to almost Mendel. It contains the kinship coefficient for pairwise individuals, which defines the genetic relatedness between individuals and could be estimated from genome-wide covariances of genotype markers. Populations are often structured in some way while there are systematic genetic variation. Linear Mixed models make use of the kinship matrix and can correct for population structure in GWAS. \citep{astle2009population,sul2013mixed}
About 37 years ago, \citet{menozzi1978synthetic} first applied Principal component analysis (PCA) in population genetics to construct maps summarizing genetic variation \citep{menozzi1978synthetic}. Nowadays, PCA is a widely used powerful non-parametric method to extract information from genetic data.  
