...
We aim to investigate the population structure variation along the genome, so we look into it for each genomic window locally. 
The choice of window length depends on the genomic data's features, such as data size and noise.
...
For example, SMARTPCA removes effects of linked blocks, while our method don't.
