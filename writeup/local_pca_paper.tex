...
\begin{align*}
    \frac{ \lambda_m }{ \sum_\ell \lambda_\ell^2 } = \frac{ \sum_{ij} ( \lambda_m U_{im} U_{jm} )^2 }{ \sum_{ij} C_{ij}^2 } .
\end{align*}
...
but the variance is computed in $\ell_2(w)$:
\begin{align*}
    \frac{ \lambda_m }{ \sum_\ell \lambda_\ell^2 } = \frac{ \sum_{ij} ( \lambda_m w_i w_j U_{im} U_{jm} )^2 }{ \sum_{ij} w_i w_j C_{ij}^2 } .
\end{align*}
