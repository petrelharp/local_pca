...
\paragraph{Testing}
Figure \ref{fig:test_missing} shows tests with lots of missing data.
Also the covariance matrix was chosen to have the top two eigenvalues equal,
so that eigenvector switching is expected.
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run 012720 (RECOMBTYPE, ``step"; SELTYPE, ``neutral")
        \label{sfig:mds_run_012720}
    }
\end{figure}
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run 027034 (RECOMBTYPE, ``base"; SELTYPE, ``neutral")
        \label{sfig:mds_run_027034}
    }
\end{figure}
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run 015598 (RECOMBTYPE, ``hotspot"; SELTYPE, ``neutral")
        \label{sfig:mds_run_015598}
    }
\end{figure}
