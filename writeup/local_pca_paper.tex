...
A note on nomenclature: In this work we describe variation in population structure using local PCA,
...
As reviewed above,
% In searching for loci of interest, 
...
Details of how we carried these out are given in the Methods.
...
of African populations of the fruit fly \textit{Drosophila melanogaster},
...
\begin{figure}
    ...
    \end{center}
    \caption{
        Population structure without inversions is correlated to recombination rate:
        \plr{XXX}
