...
any samples carrying inversions.
...
As for the \textit{Drosophila} data, we applied our method separately on all 22 human autosomes.
...
Therefore, to control the effect of sampling on our results,
