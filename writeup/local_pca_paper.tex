...
\begin{figure}
    \begin{center}
       \includegraphics[width=1\textwidth]{Fig1_allchr_Together_MDS_plot_compact}
    \end{center}
    \caption{
...
\begin{figure}
    \begin{center}
       \includegraphics[width=0.9\textwidth]{Fig2_pca_plots_allchr_3peaks_byMDS}
    \end{center}
    \caption{      
...
\begin{figure}
    \begin{center}
       \includegraphics[width=0.9\textwidth]{Fig3_pca_plots_color_by_inv_allchr}
    \end{center}
    \caption{
