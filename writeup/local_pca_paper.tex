...
\begin{figure}
    \begin{center}
        \ifusepngs
            \includegraphics{MDS_allchr_Together_plot_samples_noinv.png}
        \else
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_012720 (RECOMBTYPE, ``step"; SELTYPE, ``neutral")
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_027034 (RECOMBTYPE, ``base"; SELTYPE, ``neutral")
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_015598 (RECOMBTYPE, ``hotspot"; SELTYPE, ``neutral")
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_005464 (RECOMBTYPE, ``base"; SELTYPE, ``selected")
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_031486 (RECOMBTYPE, ``base"; SELTYPE, ``selected")
...
\begin{figure}
    ...
    \end{center}
    \caption{
        MDS visualizations of simulation run_009673 (RECOMBTYPE, ``step"; SELTYPE, ``selected")
