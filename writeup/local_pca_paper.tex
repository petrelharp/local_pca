...
\plr{Peter to add bit about weighted PCA}
...
\plr{Peter add sentence about weighted PCA.}
...
\plr{and we have methods to do this}
...
(equations \ref{eqn:est_cov}),
\plr{(say we have explored)}
