...
for(i in 1:length(fn))
{
    ...
    write.table(windist,file=paste("/home/cmb-12/fs3/hli465/FormatVCFbgz/pairwise_distance_between_win103",fn[i],"PCAk5",sep="_"),sep="\t")
...
data<-read.table(gettextf("pairwise_distance_between_win103_%s_PCAk5",chr),check.names=FALSE)
...
pdf(file="/home/cmb-12/fs3/hli465/FormatVCFbgz/Medicago_MDS_plot_allchr_win103_PCAk5.pdf",width=5,height=7)
