...
for(i in 1:length(fn))
{
    ...
    write.table(windist,file=paste("/home/cmb-12/fs3/hli465/FormatVCFbgz/pairwise_distance_between_win104",fn[i],"PCAk2",sep="_"),sep="\t")
...
pdf(file="/home/cmb-12/fs3/hli465/FormatVCFbgz/Medicago_MDS_plot_allchr_win104_PCAk2.pdf",width=5,height=7)
